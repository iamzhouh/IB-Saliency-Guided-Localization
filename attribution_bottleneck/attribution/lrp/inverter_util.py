...
from attribution_bottleneck.attribution.lrp.utils import pprint, Flatten, Identity
...
class RelevancePropagator:
    ...
    def compute_propagated_relevance(self, layer, relevance):
        if isinstance(layer, self.pooling_layers):
